...
namespace CoreOfArts.BlockEntityRenderer
{
    public class COAPotInFirepitRenderer : IInFirepitRenderer
    {
        ...
        public COAPotInFirepitRenderer(ICoreClientAPI capi, ItemStack stack, BlockPos pos, bool isInOutputSlot)
        {
            this.capi = capi;
            this.pos = pos;
